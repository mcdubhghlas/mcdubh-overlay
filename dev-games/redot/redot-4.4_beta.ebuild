...
SRC_URI="https://github.com/Redot-Engine/redot-engine/releases/download/2024101114/redot-linuxbsd.zip -> ${P}.zip"
...
src_compile() {
	...
	local esconsargs=(
		...
		builtin_rvo2=yes # bundled copy has redot-specific changes
